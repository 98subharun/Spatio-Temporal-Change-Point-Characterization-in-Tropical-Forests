...
<div align="center">
  <img src="https://latex.codecogs.com/png.latex?\dpi{150}\color{white}\LARGE
  Y_t=T_t+S_t+e_t
  " alt="BFAST decomposition"/>
</div>

<div align="center">
  <img src="https://latex.codecogs.com/png.latex?\dpi{150}\color{white}\LARGE
  T_t=\alpha_0+\alpha_1t+\sum_{k=1}^{K}\beta_kD_k(t)
  " alt="BFAST trend model"/>
</div>

<div align="center">
  <img src="https://latex.codecogs.com/png.latex?\dpi{150}\color{white}\LARGE
  S_t=\sum_{j=1}^{J}\left(\gamma_{1j}\sin\frac{2\pi jt}{f}+\gamma_{2j}\cos\frac{2\pi jt}{f}\right)
  " alt="BFAST seasonal model"/>
</div>
...
<div align="center">
  ...
  " alt="CNN layer operation"/>
</div>

<div align="center">
  <img src="https://latex.codecogs.com/png.latex?\dpi{150}\color{white}\LARGE
  z=\text{GlobalAvgPool}(h_L)
  " alt="CNN embedding extraction"/>
</div>
